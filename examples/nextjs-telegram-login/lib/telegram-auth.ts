...
diff --git a/examples/nextjs-telegram-login/lib/telegram-auth.ts b/examples/nextjs-telegram-login/lib/telegram-auth.ts
new file mode 100644
index 0000000000000000000000000000000000000000..e9ee09bb0b27df1878a71878a977d22987fa0728
--- /dev/null
+++ b/examples/nextjs-telegram-login/lib/telegram-auth.ts
@@ -0,0 +1,111 @@
